...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/tikzlibraryanimations.code.tex,v 1.43 2016/04/25 14:58:37 tantau Exp $
...
\tikzanimationdefineattribute{text}{pgf attribute name=fill, node type=.text, pgf attribute name scope=none}
...
\def\tikz@timeline@entry#1#2#3#4{%
  ...
  \expandafter\ifx\csname tikz@a@tlc@#1@#2@#3\endcsname\relax%
    % No, first entry!
    \def\tikz@anim@initial@options{#4}%
