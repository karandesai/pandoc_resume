...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/systemlayer/pgfsys.code.tex,v 1.92 2016/05/02 16:09:39 tantau Exp $
...
\def\pgfsys@begin@idscope{%
  \begingroup%
    \expandafter\let\expandafter\pgfsys@beg@save\csname pgf@sys@att@beg@\pgfsys@id@refcurrent\endcsname%
    \expandafter\let\expandafter\pgfsys@end@save\csname pgf@sys@att@end@\pgfsys@id@refcurrent\endcsname%
...
% Type: view box
%
% "path" adds an animation of the path to the next path.
% Type: path
%
